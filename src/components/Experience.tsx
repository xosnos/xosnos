          ...
          <div className="space-y-8">
            {items.map((item) => (
              <ScrollRevealItem key={item.id}>
                <div className="group bg-background rounded-3xl border border-border/50 p-8 md:p-10 shadow-sm transition-[box-shadow,border-color,transform] duration-300 hover:shadow-2xl hover:border-accent/20 hover:-translate-y-1">
