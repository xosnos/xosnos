...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-6 py-6 md:py-20 [@media(max-height:600px)]:py-3">
        <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
          <div className="group relative mb-4 md:mb-10 [@media(max-height:600px)]:mb-2">
            ...
            <div className="relative p-1 bg-gradient-to-tr from-accent to-blue-600 rounded-full">
              <Image
                ...
                width={180}
                height={180}
                className="relative z-10 h-28 w-28 rounded-full border-4 border-background bg-background shadow-2xl sm:h-32 sm:w-32 md:h-[180px] md:w-[180px] [@media(max-height:600px)]:h-24 [@media(max-height:600px)]:w-24"
          ...
          <div className="mb-4 flex w-full flex-col items-center gap-2 pb-1 md:mb-8 md:gap-4 md:pb-3 [@media(max-height:600px)]:mb-2">
          ...
          <RichText
            ...
            className="mb-5 max-w-2xl text-base leading-relaxed text-pretty text-muted-foreground md:mb-12 md:text-2xl [@media(max-height:600px)]:mb-3 [@media(max-height:600px)]:text-sm"
          />
