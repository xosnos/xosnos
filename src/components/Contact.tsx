...
const Contact = () => {
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-accent/10 rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[50%] h-[50%] bg-blue-600/10 rounded-full blur-[160px] pointer-events-none" />
