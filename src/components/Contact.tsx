...
const Contact = () => {
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-accent/10 rounded-full blur-[160px] pointer-events-none animate-pulse motion-reduce:animate-none" />
      <div
        className="absolute bottom-0 left-0 w-[50%] h-[50%] bg-blue-600/10 rounded-full blur-[160px] pointer-events-none animate-pulse motion-reduce:animate-none"
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <ScrollReveal>
            <div className="space-y-4">
              ...
              <h2 className="text-5xl md:text-7xl font-montserrat font-extrabold tracking-tighter text-foreground text-balance">
                {contactContent.sectionTitle}{' '}
                <span className="text-accent">{contactContent.sectionTitleAccent}</span>
              </h2>
              <p className="text-xl md:text-2xl text-muted-foreground font-light max-w-2xl mx-auto leading-relaxed text-pretty">
